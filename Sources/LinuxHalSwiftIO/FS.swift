...
@c
func swifthal_fs_open(_ fp: UnsafeMutablePointer<UnsafeMutableRawPointer?>?, _ path: UnsafePointer<CChar>?, _ flags: UInt8) -> CInt {
  fp?.pointee = nil
...
@c
func swifthal_fs_write(_ fp: UnsafeMutableRawPointer?, _ buf: UnsafeRawPointer?, _ size: Int) -> CInt {
...
@c
func swifthal_fs_read(_ fp: UnsafeMutableRawPointer?, _ buf: UnsafeMutableRawPointer?, _ size: Int) -> CInt {
  if size < 0 { return -EINVAL }
...
@c
func swifthal_fs_opendir(_ dp: UnsafeMutablePointer<UnsafeMutableRawPointer?>?, _ path: UnsafePointer<CChar>?) -> CInt {
  guard let path else { return -EINVAL }
...
private func setDirentName(_ entry: UnsafeMutablePointer<swift_fs_dirent_t>, _ name: UnsafePointer<CChar>) {
...
@c
func swifthal_fs_readdir(_ dp: UnsafeMutableRawPointer?, _ entry: UnsafeMutablePointer<swift_fs_dirent_t>?) -> CInt {
...
@c
func swifthal_fs_stat(_ path: UnsafePointer<CChar>?, _ entry: UnsafeMutablePointer<swift_fs_dirent_t>?) -> CInt {
...
@c
func swifthal_fs_statfs(_ path: UnsafePointer<CChar>?, _ stat: UnsafeMutablePointer<swift_fs_statvfs_t>?) -> CInt {
